...
user_height = float(input("Enter your height as meters: "))
...
print("\n-------FINAL REPORT-------")
print(f"the user BMI is, {user_bmi:.2f}")
print(f"Does the user healthy? {check_bmi}")
print(f"The user is {classification}")   