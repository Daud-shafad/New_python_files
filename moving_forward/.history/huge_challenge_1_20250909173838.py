...
match average_grade:
    case average_grade if student_1_grade or student_2_grade or student_3_grade >= 90 and student_1_grade or student_2_grade or student_3_grade <= 100: 
        print("Excellent")
    case average_grade if student_1_grade or student_2_grade or student_3_grade >= 70 and student_1_grade or student_2_grade or student_3_grade <= 89:
        print("Good")   
    case average_grade if student_1_grade or student_2_grade or student_3_grade >= 50 and student_1_grade or student_2_grade or student_3_grade <= 69:
        print("Average")
    case average_grade if student_1_grade or student_2_grade or student_3_grade < 50:
        print("Poor")
    case _:
