...
match average_grade:
    case average_grade if student_1_grade >= 90 <= 100: 
        print("Excellent")
    case average_grade if student_2_grade >= 90 <= 100: 
        print("Excellent")
    case average_grade if student_3_grade >= 90 <= 100: 
        print("Excellent")
    case average_grade if student_1_grade >= 70 <= 89: 
        print("Good")
    case average_grade if student_2_grade >= 70 <= 89: 
        print("Good")
    case average_grade if student_3_grade >= 70 <= 89: 
        print("Good")
    case average_grade if student_1_grade >= 50 <= 69: 
        print("Average")
    case average_grade if student_2_grade >= 50 <= 69: 
        print("Average")
    case average_grade if student_3_grade >= 50 <= 69: 
        print("Average")
