...
match average_grade:
    case average_grade if student_1_grade >= 90 or student_1_grade <= 100: 
        print("Excellent")
    case average_grade if student_2_grade >= 90 or student_2_grade <= 100: 
        print("Excellent")
    case average_grade if student_3_grade >= 90 or student_3_grade <= 100: 
        print("Excellent")
    case average_grade if student_1_grade >= 70 or student_1_grade <= 89: 
        print("Good")
    case average_grade if student_2_grade >= 70 or student_2_grade <= 89: 
        print("Good")
    case average_grade if student_3_grade >= 70 or student_3_grade <= 89: 
        print("Good")
    case average_grade if student_1_grade >= 50 or student_1_grade <= 69: 
        print("Average")
    case average_grade if student_2_grade >= 50 or student_2_grade <= 69: 
        print("Average")
    case average_grade if student_3_grade >= 50 or student_3_grade <= 69: 
        print("Average")
    case average_grade if student_1_grade < 50: 
        print("Poor")
    case average_grade if student_2_grade < 50: 
        print("Poor")
    case average_grade if student_3_grade < 50: 
        print("Poor")
    case _:
        print("Invalid Grade number, try again")
