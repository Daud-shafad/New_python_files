        ...
        match  user_choice:
            ...
            case '2':
                ...
                if emp_id in employee_man_dict:
                    ...
                    employee_man_dict[emp_id].extend(emp_name)
                    employee_man_dict[emp_id].extend(emp_dept)
                    employee_man_dict[emp_id].extend(emp_salary)
            ...
            case '3':
                emp_id = int(input("Enter Your ID: "))
                if emp_id in employee_man_dict:
                    employee_man_dict.update({emp_id :[emp_name, emp_dept, emp_salary]})
