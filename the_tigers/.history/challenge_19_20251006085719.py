        ...
        match  user_choice:
            case '1':
                ...
                if emp_id not in employee_man_dict:
                   ...
                   employee_man_dict[emp_id].append(emp_dept)
                   employee_man_dict[emp_id].append(emp_salary)
                   employee_man_dict[emp_id] = [emp_name, emp_dept, emp_salary]
            ...
            case '2':
                ...
                if emp_id in employee_man_dict:
                    ...
                    employee_man_dict[emp_id][2] = new_salary
            ...
            case '3':
                ...
                if emp_id in employee_man_dict:
                    ...
                    print(f"The ID you entered Has This Data {employee_man_dict[emp_id]}")
                    
                else:
                    print("Employee not foundAdd the Employee firstly")
