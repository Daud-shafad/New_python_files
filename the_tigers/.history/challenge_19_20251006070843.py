        ...
        match  user_choice:
            case '1':
                ...
                if emp_id not in employee_man_dict:
                   ...
                   employee_man_dict[emp_id].append(emp_id)
            ...
            case '3':
                emp_id = int(input("Enter Your ID: "))
                if emp_id in employee_man_dict:
                    print(f"Your data is{employee_man_dict[emp_id]}, {employee_man_dict[emp_name]}, {employee_man_dict[emp_dept]}, {employee_man_dict[emp_salary]}")
                else:
