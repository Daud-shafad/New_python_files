    ...
    if user_choice == '5':
        ...
        match  user_choice:
            ...
            case '2':
                ...
                elif emp_id in employee_man_dict and emp_id == emp_id:
                    emp_salary = int(input("Enter Your New salary: "))
                    employee_man_dict.update(emp_id[emp_salary])
                else:
                    print("Add Employee Firstly")
            case '3':
                emp_id = int(input("Enter Your ID: "))
                if emp_id in employee_man_dict:
                    employee_man_dict.get(emp_id)
