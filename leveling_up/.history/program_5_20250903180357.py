...
while True:
 ...
 if users_vote_name == "mohamoud":
   print(candidates_name[users_vote_name.count("mohamoud")])
""" elif users_vote_name == "mouse":
   print(candidates_name[users_vote_name.count("mouse")])
 elif users_vote_name == "abdirahman":
   print(candidates_name[users_vote_name.count("abdirahman")])
 elif users_vote_name == "faysal":
   print(candidates_name[users_vote_name.count("faysal")])
   """
 else:
