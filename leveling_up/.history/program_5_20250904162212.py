...
while True:
 ...
 if users_vote_name == "stop":
     break
 if users_vote_name == candidates_name[0]:
   print(candidates_name.count("mohamoud"))
 elif users_vote_name == candidates_name[1]:
   print(candidates_name.count("mouse"))
 elif users_vote_name == candidates_name[2]:
   print(candidates_name.count("abdirahman"))
 elif users_vote_name == candidates_name[3]:
