...
while True:   
   ...
   if customer_choice == 'done':
       break
   if customer_choice in dict_items:
     print(f"The price of purchased item is ${dict_items[customer_choice]}")
     continue 
num_of_items = int(input(f"Enter the number of items you want{customer_choice}: "))
if num_of_items > 0:
    print("You followed right.")
else:
    print("You followed wrong.")
    
total = num_of_items *  dict_items[customer_choice] 
