        ...
        match user_choice:
            ...
            case '5':
                ...
                if user_name not in cafeteria_items_dict:
                   ...
                   print(f"You have an order of: {cafeteria_items_dict[user_name][user_orders, total]}")
            ...
            case '6':
                ...
                match user_payment_type:
                    ...
                    case '2':
                        ...
                        print(f"Your card number is: ${user_card}")
                        amount_total = float(input("Enter the amount: $ "))
                        print("\n-----FINAL RECEIPT:-----")
                        print("Your name is: {user_name}")
                        print("Your orders are: {user_orders}")
                    ...
                    case '3':
                        ...
                        print(f"You Sent the business number of {user_mobile}")
                        amount_total = float(input("Enter the amount: $ "))
                        print("\n-----FINAL RECEIPT:-----")
