...
while True:
    ...
    if user_choice == '7':
        ...
        match user_choice:
            ...
            case '4':
                 print(f"Americano price is: ${2.6}")
                 user_name = input("Enter Your name: ")
                 total += 2.6
            ...
            case '5':
                user_name = input("Enter Your name: ")
                user_orders = input("Enter Your orders: ").split(",")
                if user_name not in cafeteria_items_dict:
                   cafeteria_items_dict[user_name] = [user_orders, f"${total}"]
                   print(f"You have an order of: {cafeteria_items_dict}")
                else:
                   print(f"You already made orders")
            
            case '6':
              
                user_payment_type = input("Enter Your payment type: (1. cash 2. card 3. mobile): ")
                match user_payment_type:
                    case '1':
                        amount_total = float(input("Enter the amount: $ "))
                        print("\n-----FINAL RECEIPT:-----")
                        print("Your name is: {user_name}")
                        print("Your orders are: {user_orders}")
                        print(f"Your Payout final receipt is: ${amount_total:.1f}, Thanks")
                        
                    case '2':
                        user_card = input("Enter Your card: ")
                        amount_total = float(input("Enter the amount: $ "))
                        print(f"Your card number is: {user_card} and you send an amount of: ${amount_total}")
                        print("\n-----FINAL RECEIPT:-----")
                        print("Your name is: {user_name}")
                        print("Your orders are: {user_orders}")
                        print(f"Your Payout final is: ${amount_total:.1f}, Thanks")
                    
                    case '3':
                        user_mobile = input("Enter the business number: ")
                        amount_total = float(input("Enter the amount: $ "))
                        print(f"You Sent the business number of {user_mobile} an amount of: ${amount_total}")
                        print("\n-----FINAL RECEIPT:-----")
                        print(f"Your name is: {user_name}")
                        print(f"Your orders are: {user_orders}")
                        print(f"Your Payout final is: ${amount_total:.1f}, Thanks")
