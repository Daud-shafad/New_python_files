...
while True:
    ...
    print("5. Search books By Title, Author, or Genre")# this is worked really well
    print("6. View Borrowing Members History")# this is worked really well
    print("7. View All Members")# this is worked really well
    print("8. View All Books")# this is worked really well
    print("9. Exit The system")# this is worked really well
        ...
        match user_choice:
            ...
            case '1':
                ...
                if book_id not in books_dict:
                    books_dict[book_id] = [book_title, book_author, book_genre, book_year, book_availability]
            ...
            case '2':
                ...
                borrowed_books = int(input("Enter borrowed Books ID: ").split())
            ...
            case '4':
                member_id = int(input("Enter member ID: "))
                book_id = int(input("Enter the Book ID: "))
                book_details = members_dict.get(member_id, {}).get('borrowed',{}).get(book_id)
                if member_id in members_dict and book_details:
                    book_title, book_author = book_details
                    books_dict[book_id] = book_details
                    del members_dict[member_id]['borrowed'][book_id]
                    books_dict.update({book_id : [book_title, book_author, book_genre, book_year, book_availability, borrower_name]})
            ...
            case '5':
                ...
                match search_book:
                  ...
                  case title if title == books_dict[101][0]:
                       books_dict.get(101)
                       result_search = f"The book you want is: {books_dict[101]}"
                       print(result_search)
                  
                  case title if title == books_dict[102][0]:
                       books_dict.get(102)
                       result_search = f"The book you want is: {books_dict[102]}"
                       print(result_search)

                  case title if title == books_dict[103][0]:
                       books_dict.get(103)
                       result_search = f"The book you want is: {books_dict[103]}"
                       print(result_search)
                  
                  case author if author == books_dict[101][1]:
                       books_dict.get(101)
                       result_search = f"The book you want is: {books_dict[101]}"
                       print(result_search)
                  
                  case author if author == books_dict[102][1]:
                       books_dict.get(102)
                       result_search = f"The book you want is: {books_dict[102]}"
                       print(result_search)

                  case author if author == books_dict[103][1]:
                       books_dict.get(103)
                       result_search = f"The book you want is: {books_dict[103]}"
                       print(result_search)
                  
                  case genre if genre == books_dict[101][2]:
                       books_dict.get(101)
                       result_search = f"The book you want is: {books_dict[101]}"
                       print(result_search)
                  
                  case genre if title == books_dict[102][2]:
                       books_dict.get(102)
                       result_search = f"The book you want is: {books_dict[102]}"
                       print(result_search)

                  case genre if title == books_dict[103][2]:
                       books_dict.get(103)
                       result_search = f"The book you want is: {books_dict[103]}"
                       print(result_search)
            ...
            case '6':
                ...
                if member_id in members_dict:
                   print(f"The member ID of {member_id} is borrowed: {borrowed_books}")
            
            case '7':
                 print(f"In the current time we have these Data of membership: {members_dict}")
