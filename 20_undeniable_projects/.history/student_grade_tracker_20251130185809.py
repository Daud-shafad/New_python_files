        ...
        match user_choice:
            ...
            case '3':
                ...
                if student_name in students_records_dict:
                    students_records_dict[student_name]
                    print(f"The grades of this student {student_name} is {students_records_dict[student_name]}")
                    print(sum(students_records_dict[student_name]))
                    grades = students_records_dict[student_name]
                    print("The sum of grades for this student is: ", sum(grades))
                    print("And The average of records is: ", sum(grades) / len(grades))
                else:
