        ...
        match user_choice:
          ...
          case '2':
              ...
              if item_id in inventory_dict:
                  ...
                  print(f"Quantities left are: {new_quantity},")
                  new_quantity = int(input("Enter the quantities left: "))
                  inventory_dict[item_id][1] = new_quantity
                  print(f"The quantities left are {new_quantity} for the {item_name}")
                  #inventory_dict[item_id] = [item_name, new_quantity, f"${item_price:.1f}"]
              else:
