        ...
        match user_choice:
            ...
            case '5':
                ...
                match search_book:
                  ...
                  case title if title in books_dict[book_id][0]:
                       books_dict.get(books_dict)
                       result_search = f"The book you want is: {books_dict[book_id]}"
                       print(result_search)
                  
                  case author if author in books_dict[book_id][1]:
                       books_dict.get(books_dict[book_id])
                       result_search = f"The book you want is: {books_dict[book_id]}"
                       print(result_search)

                  case genre if genre in books_dict[book_id][2]:
                       books_dict.get(books_dict[book_id])
                       result_search = f"The book you want is: {books_dict[book_id]}"
                       print(result_search)
