    ...
    if student_choice == '5':
        ...
        match student_choice:
           ...
           case '4':
                student_name = input("Enter Your name: ")
                if student_name in student_grade_manager:
                    sum_total = sum(student_grade_manager[student_name][student_grades]) 
                    length_total = len(student_grade_manager[student_name][student_grades])
                    average = sum_total / length_total
