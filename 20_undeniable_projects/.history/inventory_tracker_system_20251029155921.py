    ...
    if user_choice == '5':
        ...
        match user_choice:
          ...
          case '2':
              ...
              if item_name in inventory_dict[item_id]:
                  print(f"You sold {sold_quantity} Quantities of {item_name}")
                  new_quantity = item_quantity - sold_quantity
                  
                  print(f"{new_quantity} is left for the ID of {item_id} which is {item_name}")
              else:
          ...
          case '3':
               ...
               print(f"You make Restock {user_order} item, Thanks for you connection")
               
          case '4':
              inventory_dict[item_id] = [item_name, new_quantity, item_price]
              restock_dict[user_phone] = [user_order, user_quantity, user_payout]
              print(f"Old/Original Inventory has these Items: {inventory_dict}")
