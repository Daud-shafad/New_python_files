    ...
    if user_choice == '6':
        ...
        match user_choice:
            ...
            case '5':
                ...
                user_count_replace = int(input("Enter the number of replacing: "))
                if user_letter_1 in user_string:
                    print(f"The replacing you make is: {user_string.replace(user_letter_1, user_letter_2, user_count_replace)}")
