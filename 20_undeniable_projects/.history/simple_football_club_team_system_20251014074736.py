...
while True:
    ...
    if user_input == '7':
        ...
        break
    elif user_input == '1' or user_input == '2' or user_input == '3' or user_input == '4' or user_input == '5' or user_input == '6':
        ...
        match user_input:
            ...
            case '5':
                team_name = input("Enter the team name: ")
                if team_name in football_team_dict:
                    view_team = football_team_dict[team_name] = [new_player, coach_name, stadium_name]
