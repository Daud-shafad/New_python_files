...
while True:
    ...
    if user_choice == '10':
        ...
        break
    elif user_choice == '1' or user_choice == '2' or user_choice == '3' or user_choice == '4' or user_choice == '5' or user_choice == '6' or user_choice == '7' or user_choice == '8' or user_choice == '9': 
       ...
       match user_choice:
        ...
        case '2':
            user_type = input("Enter the type you're converting(int/complex): ")
        ...
        case '4':
            ...
            if user_type != str: 
               print(str(user_type)) 
                ...
                print("You already have a string type")
        ...
        case '5':
            ...
            if user_type != bool: 
               print(bool(user_type)) 
                ...
                print("You already have a bool type")
        ...
        case '6':
            ...
            if user_type != list: 
               print(list(user_type)) 
                ...
                print("You already have a list type")