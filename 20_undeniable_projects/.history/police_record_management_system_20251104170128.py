        ...
        match user_choice:
            ...
            case '2':
                ...
                if case_name not in police_record_dict:
                   ...
                   print(f"You added a case name of {case_name} belongs the officer_ID of {officer_ID}")
            ...
            case '3':
                ...
                if complain_desc not in police_record_dict:
                   ...
                   print(f"the officer {officer_ID} is registered a ({complain_desc})")
                else:
            ...
            case '4':
                ...
                if officer_ID not in officers_record:
                   officers_record[officer_ID] = (suspector_ID, suspector_name, suspector_age, suspector_gender, suspector_arrest)
                   print(f"You registered new suspector {suspector_ID} successfully") 
                else:
            ...
            case '5':
                ...
                if officer_ID in police_record_dict:
                   print(f"The officer you searched has this data: { police_record_dict.get(officer_ID)}") 
                else:
                   print("the ID of {officer_ID} was not Found. Register it firstly") 
            
            case '6':
                print(f"All the cases and DATA  that is registered are: {police_record_dict}")
