...
if words_list[0] not in unique_words_set:
    unique_words_set.add(0)
    print(unique_words_set)
elif "awesome" not in unique_words_set:
    unique_words_set.add("awesome")
elif "language" not in unique_words_set:
    unique_words_set.add("language")
elif "maverick" not in unique_words_set:
    unique_words_set.add("maverick")
elif "top" not in unique_words_set:
    unique_words_set.add("top")