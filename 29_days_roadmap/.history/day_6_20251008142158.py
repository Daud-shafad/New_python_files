        ...
        match user_choice:
            ...
            case '2':
                ...
                if user_id not in  library_books_dict:
                    ...
                    print(f"You Added a new book '{user_id}', for the name of '{user_book}', & author of '{user_author}'")
                else:
            ...
            case '5':
                ...
                user_id = int(input("Enter the ID of the book you want to borrow: "))
                if user_id in library_books_dict:
                    print(f"You borrowed the book belongs the ID of {user_id}, please keep it.")
                    books_borrowed.append(library_books_dict[user_id])
                    person_borrowed.add(user_name)
                    print(f"Borrowed books are: {library_books_dict[user_id]} = {books_borrowed}")
                    print(f"the person borrowed is: {user_name} and he is in the collection of borrowers {person_borrowed}")
                else:
